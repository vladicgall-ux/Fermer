...
| Вход без Telegram (браузер/PWA): регистрация и вход по логину и паролю | ✅ | ✅ |
...
Открыв сайт напрямую (браузер на Android/iOS/ПК), пользователь регистрируется: имя, логин, пароль.
