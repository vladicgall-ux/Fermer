// Telegram Web App SDK (telegram.org/js/telegram-web-app.js), копия из @twa-dev/sdk 8.0.2 (MIT).
// Раздаётся с нашего домена, чтобы Mini App не зависел от доступности telegram.org.
// WebView
(function () {
  var eventHandlers = {};
